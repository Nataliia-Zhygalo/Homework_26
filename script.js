...
function displayProducts(category, newArr) {
  const listProducts = newArr
    .map((product) => {
...
document.write(`
  <table>
    ...
    <tbody>
      ${displayProducts('kitchen', kitchenProducts)}
      ${displayProducts('devices', devicesProducts)}
      ${displayProducts('cosmetics', cosmeticsProducts)}
    </tbody>
  </table>
